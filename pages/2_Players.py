...
col1, col2, col3, col4 = st.columns(4)
col1.metric('Valor de Mercado', value=f'£ {player_stats["Value(£)"]:,.2f}')
col2.metric('Remuneração Semanal', value=f'£ {player_stats["Wage(£)"]:,.2f}')
col3.metric('Claúsula de Rescisão',
